...
const translations: Translations = {
  ...
  // Testimonials
  'testimonial.ron.text': { en: 'Working with HOLYLABS was a game-changer for my business. Their Voice conversations AND WhatsApp agent automation has transformed how we handle customer interactions. The results were immediate—better response times and significantly improved customer satisfaction. Highly recommended!', he: 'עבודה עם הולי לאבס הייתה שינוי מהותי לעסק שלי. האוטומציה של שיחות קוליות וסוכני וואטסאפ שלהם שינתה את האופן שבו אנחנו מטפלים באינטראקציות עם לקוחות. התוצאות היו מיידיות - זמני תגובה טובים יותר ושיפור משמעותי בשביעות רצון הלקוחות. מומלץ בחום!' },
  'testimonial.tamar.text': { en: 'HOLYLABS built us an automated hiring system with a rejection system that manages automatic conversations via email and lets employers fill forms seamlessly. This has completely transformed our recruitment process—we can now handle hundreds of applications efficiently while maintaining personalized communication.', he: 'הולי לאבס בנתה לנו מערכת גיוס אוטומטית עם מערכת דחייה שמנהלת שיחות אוטומטיות באמצעות אימייל ומאפשרת למעסיקים למלא טפסים בצורה חלקה. זה שינה לחלוטין את תהליך הגיוס שלנו - אנחנו יכולים כעת לטפל במאות בקשות ביעילות תוך שמירה על תקשורת מותאמת אישית.' },
  'testimonial.erez.text': { en: 'HOLYLABS built us a beautiful dashboard for our property management system with marketplace functionality. The interface is intuitive, the marketplace integration is seamless, and it has revolutionized how we manage our properties and connect with clients. The results exceeded our expectations!', he: 'הולי לאבס בנתה לנו דשבורד יפהפה למערכת ניהול הנכסים שלנו עם פונקציונליות שוק. הממשק אינטואיטיבי, האינטגרציה עם השוק חלקה, וזה שינה לחלוטין את האופן שבו אנחנו מנהלים את הנכסים שלנו ומתחברים עם לקוחות. התוצאות עלו על הציפיות שלנו!' },
